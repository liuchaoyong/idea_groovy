...
def generate(table, dir) {
  ...
  new File(dir, className + "VO.java").withPrintWriter("UTF-8") { out -> generate(dir , table , out, className, fields) }
}
...
def generate(dir, table, out, className, fields) {
  ...
  out.println " */"
  out.println "@Data"
  out.println "@ApiModel(value=\""+ className +"VO\" ,description =\"" + table.getComment() + "\")"
  out.println "public class " +  className  + "VO{"
  out.println ""
  fields.each() {
