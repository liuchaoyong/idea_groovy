...
def generate(table, dir) {
  ...
  new File(dir, className + "ServiceImpl.java").withPrintWriter("UTF-8") { out -> generate(dir , table , out, className, fields) }
}
...
def generate(dir, table, out, className, fields) {
  ...
  out.println "import "+packageName[0..-15]+".dao.${className}Mapper;"
  out.println "import "+packageName[0..-15]+".domain.${className};"
  out.println "import "+packageName[0..-7]+".${className}Service;"
  out.println "import org.springframework.stereotype.Service;"
  out.println "import org.springframework.transaction.annotation.Transactional;"

  out.println ""
  out.println "/**"
  out.println " * " + table.getComment() + "serviceImpl"
  ...
  out.println ""
  out.println "    private final "+className+"Mapper "+className[0..1].toLowerCase() +className[1..-1]+"Mapper;"
  out.println ""
  out.println "    public "+className+"ServiceImpl("+className+"Mapper "+className[0..1].toLowerCase() +className[1..-1]+"Mapper) {"
  out.println "        this."+className[0..1].toLowerCase() +className[1..-1]+"Mapper = "+className[0..1].toLowerCase() +className[1..-1]+"Mapper;"
  out.println "    }"
  out.println ""
  out.println "}"
}
